  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="mt-8">
              ...
              <div className="space-y-3">
                <p className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-0.5 text-muted-foreground" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div>
          <form onSubmit={handleSubmit} className="bg-surface border border-border p-6 rounded-xl shadow-sm">
            {status.message && (
              <div
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-border bg-surface text-foreground rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-ring"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-primary text-primary-foreground py-2 px-4 rounded-md hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
